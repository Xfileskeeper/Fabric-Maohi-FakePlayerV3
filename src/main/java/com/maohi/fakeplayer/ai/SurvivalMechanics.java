...
public class SurvivalMechanics {
	...
	public static void autoSmeltOres(ServerPlayerEntity player) {
		...
		if (pers.currentTask == com.maohi.fakeplayer.VirtualPlayerManager.TaskType.CRAFTING) return; // 别和合成冲突
	 ...
	 */
	public static void tickSmelting(ServerPlayerEntity player, com.maohi.fakeplayer.VirtualPlayerManager.Personality pers) {
